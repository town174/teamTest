...
void Data_Update(Object src,EventArgs e)
 {
  ...
  if(IsNum(Id))
   {
    string sql="update pa_keylink set [key]='"+Sql_Format(key.Text.Trim())+"',[link]='"+Sql_Format(link.Text.Trim())+"' where id="+Id;
    conn.Open();
    OleDbCommand Comm=new OleDbCommand(sql,conn);
...
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 ...
 <tr><td class=table_style1 align="left"><b>关键词链接修改</b></td></tr>
 <tr><td height=10></td></tr>
</table>
<table border=0 cellpadding=0 cellspacing=0 width=95% >
 <tr>
