...
<br>
<div align=center>
<asp:Button Text=" 更新订单信息 " runat="server" CssClass="bt" Onclick="Update_Info" />&nbsp; 
<input type="button" class=bt  value=" 返回 "  onclick="location.href='order_list.aspx?username=<%=Server.UrlEncode(Request.QueryString["username"])%>'">
</div>
</td>
</tr>
</table>
