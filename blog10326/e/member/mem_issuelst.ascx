...
<a href="javascript:Issue('<%#DataBinder.Eval(Container.DataItem,"thetable")%>','<%#DataBinder.Eval(Container.DataItem,"detail_id")%>','<%#DataBinder.Eval(Container.DataItem,"work_id")%>')">签发</a></td>
                </tr>
             </ItemTemplate>
          </asp:Repeater>
 </table>
...
<script type="text/javascript">
 ...
 function Issue(Table,Id,Wid)
  {
   var Url="/e/member/issue.aspx?s="+Sid+"&table="+Table+"&detailid="+Id+"&workid="+Wid;
