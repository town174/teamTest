...
<div class="module_content">
 <ul class="fbklist">
  <asp:Repeater Id="Plist" Runat="server" OnItemDataBound="Data_Bound">
    <ItemTemplate>
    <li class="left finfo"><a href="/e/space/?username=<%#Server.UrlEncode(DataBinder.Eval(Container.DataItem,"fbk_username").ToString())%>" target="space"><%#DataBinder.Eval(Container.DataItem,"fbk_username")%></a> <span class="finfo">发布于：<%#DataBinder.Eval(Container.DataItem,"fbk_date","{0:yyyy-MM-dd HH:mm:ss}")%></span></li>
