...
protected void Data_Update(Object src,EventArgs e)
 {
  ...
  //其他属性
    ...
    if(Request.Form["permissions_set"]=="1")
     {
      sublanmu_str+=",permissions='"+Visitors+"'";
     }
    if(Request.Form["ck_zdyurl"]=="1")
     {
      sublanmu_str+=",zdy_url='"+Sql_Format(tb_zdyurl.Text)+"'";
     }
    if(Request.Form["ck_headcontent"]=="1")
     {
      sublanmu_str+=",content='"+Sql_Format(tb_headcontent.Text)+"'";
     }
...
private void MemberType_Bind()
 {
   string sql="select id,name from pa_member_type where site_id in(0,"+SiteId+") order by xuhao,id";
