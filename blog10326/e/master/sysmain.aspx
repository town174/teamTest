...
<table border=0 width="95%" cellpadding="2" cellspacing="0"  align="center" class="tablestyle">
             <tr>
               <td height="25px" width=100px class="tdstyle">版本信息：</td><td class="tdstyle"><span id="updatedate"></span></td>
             </tr>
             <tr>
...
var updatedate="2014-10-10";
var version="V3.0.20141010";
var isbusiness=<%=IsBusiness%>;
document.getElementById("updatedate").innerHTML=version;
