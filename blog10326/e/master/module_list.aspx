...
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 ...
 <tr><td class=table_style1><a href="javascript:location.reload()" title="点击刷新"><b><%=Type%>模块管理</b></a></td></tr>
 <tr><td height=10></td></tr>
</table>
<table border=0 cellpadding=0 cellspacing=0 width=95% >
 <tr>
...
function set(act)
 ...
 {
   IDialog("模块批设置","module_pset.aspx?lanmuname=<%=Request.QueryString["lanmuname"]%>",750,480);
 }
