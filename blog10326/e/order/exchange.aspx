...
<li>联系姓名：<input type="text" name="truename" id="truename" maxlength="30"  style="width:150px;height:20px;border:1px solid #cccccc;"></li>
<li>联系电话：<input type="text" name="tel" id="tel" maxlength="30"  style="width:150px;height:20px;border:1px solid #cccccc;"></li>
<li>电子邮箱：<input type="text" name="email" id="email" maxlength="30"  style="width:150px;height:20px;border:1px solid #cccccc;"></li>
<li>收货地址：<input type="text" name="address"  id="address" maxlength="100"  style="width:350px;height:20px;border:1px solid #cccccc;"></li>
<li>邮政编码：<input type="text" name="postcode" id="postcode" maxlength="6" onkeyup="if(isNaN(value))execCommand('undo');"  style="width:150px;height:20px;border:1px solid #cccccc;"></li>
  ...
  <input type="button" id="bt" value=" 确定兑换 " onclick="Check_Inptut()"/>&nbsp;&nbsp;
