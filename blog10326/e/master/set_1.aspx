...
<aspcn:uc_fckeditor  Tb_Id="wz_top" Fck_Height="250" Fck_Style="Basic" Fck_EnterMode="br" runat="server"/>
</td>
 </tr>
...
<tr>
 ...
 <td align="left" >
<asp:TextBox id="wz_banner" TextMode="multiLine"  runat="server" />
<aspcn:uc_fckeditor Tb_Id="wz_banner" Fck_Height="250" Fck_Style="Basic" Fck_EnterMode="br" runat="server"/>
</td>
</tr>
...
<aspcn:uc_fckeditor  Tb_Id="wz_bottom" Fck_Height="250" Fck_Style="Basic" Fck_EnterMode="br" runat="server"/>
</td>
 </tr>
</table>
</div>
...
<aspcn:uc_fckeditor Tb_Id="em_sign" Fck_Height="120" Fck_Style="Simple" Fck_EnterMode="br" runat="server" />
</td>
</tr>
<tr>
  <td align="left"></td>
 <td align="left"><input type="button" value="发送测试邮件" onclick="SendTest('email')"></td>
</td>
</tr>
</table>
</div>
...
<tr>
  <td align="left"></td>
 <td align="left"><input type="button" value="查看账户信息" onclick="SmsInfo()"> &nbsp;  <input type="button" value="发送测试短信" onclick="SendTest('sms')">
</td>
</td>
</tr>
</table>
...
<table border=0 cellpadding=5 cellspacing=0 width=100% align=center>
<tr>
   <td align="left" style="width:150px">当前位置前缀</td>
   <td align="left"><asp:TextBox id="Tb_Location_Prefix" runat="server" maxlength="100" size="60"/> &nbsp;<span style="color:#666666">如：当前位置：&lt;a href=/&gt;首页&lt;/a&gt;</span></td>
</tr>
...
<tr>
  ...
  <td align="left"><textarea id="forbid_keyword" name="forbid_keyword" cols="60" rows="5"><%=forbid_keyword%></textarea></td>
</tr>

<tr>
  <td align="left">替换关键字<br><font color=#666666>多个关键字用|分开<br>前台提交后将被替换成***</font></td>
  <td align="left"><textarea id="replace_keyword" name="replace_keyword" cols="60" rows="5"><%=replace_keyword%></textarea></td>
</tr>
...
function Format_Fck()
 {
   var oEditor,fckhtml;
   var fckids="wz_top,wz_banner,wz_bottom";
   var Afckids=fckids.split(',');
   for(i=0;i<Afckids.length;i++)
   {
    oEditor=FCKeditorAPI.GetInstance(Afckids[i]);
    if(oEditor!=null)
    {
