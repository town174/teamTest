...
private void Update_Member(string Uid,DateTime LoginDate,string login_key)
 {
   string Lst_Ip=GetClientIP();
   sql="update pa_member set login_key='"+login_key+"',lastdate='"+LoginDate+"',lst_ip='"+Lst_Ip+"',logins=logins+1 where id="+Uid;
   OleDbCommand Comm=new  OleDbCommand(sql,conn);
   Comm.ExecuteNonQuery();
 }
...
.inputbox{width:140px;border:1px solid #999999;height:20px}
.yzm{width:60px;}
