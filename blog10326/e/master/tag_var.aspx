...
<br><textarea id="Use_Beizhu" style="width:650px;height:130px;font-size:13px;">
代码演示：
&lt;% 
DataTable dt=Get_Data("select top 1 * from article"); 
DataRow dr;
...
代码演示：
&lt;% 
DataTable dt=Get_Data("select * from article","select count(id) as co from article",5); 
DataRow dr;
for(int i=0;i<dt.Rows.Count;i++)
 {
  dr=dt.Rows[i]; //说明：给dr赋值
