...
public partial class Receive : System.Web.UI.Page
{
    ...
    protected string UserName,status_msg,SiteId;
               ...
               if(!Fnc_rk(v_oid))
                {
                  ...
                  SendMail(M_body);
                  Response.Redirect("/e/member/index.aspx?type=mem_payresult&s="+SiteId+"&pay_no="+v_oid+"&pay_amount="+v_amount+"&pay_type="+Server.UrlEncode("网银在线"));
                }
               else
                {
