...
protected void Data_Update(Object src,EventArgs e)
 {
    ...
    if(Request.Form["ck_zdyurl"]=="1")
     {
      sql_lanmu+=",zdy_url='"+Sql_Format(tb_url.Text)+"'";
     }
    if(Request.Form["ck_dropmenuzdy"]=="1")
     {
       sql_lanmu+=",zdy_dropmenu='"+Sql_Format(Dropmenuzdy.Text)+"'";
     }
...
<table border=0 cellpadding=2 cellspacing=0 width=100% align=center>
 <tr>
  <td  height=30 width="130px"><input type="checkbox" name="ck_css" value="1">风格样式</td>
