...
<table  border=0 cellpadding=0 cellspacing=0 width=95% >
 ...
 <tr><td class=table_style1><a href="javascript:location.reload()" title="点击刷新"><b>子栏目管理</b></a></td></tr>
 <tr><td height=10></td></tr>
</table>
<table border=0 cellpadding=0 cellspacing=0 width=95% >
 <tr>
...
function Sublanmu_PSet(name)
 {
   IDialog("子栏目批设置",'sublanmu_pset.aspx?lanmuid=<%=Request.QueryString["lanmuid"]%>&name='+encodeURI(name),750,400);
 }
