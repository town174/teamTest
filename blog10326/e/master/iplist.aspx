  ...
  if(!Page.IsPostBack) 
   {
       ...
       ViewState["constr"]=myconn.Constr();//获取连接字符串
...
<ItemTemplate>
 <tr class="listitem">
  ...
  <td  class="tdstyle" align="left"><span onclick="GO_Url('<%#DataBinder.Eval(Container.DataItem,"urlfrom")%>')" style="cursor:pointer"><%#DataBinder.Eval(Container.DataItem,"urlfrom")%></a></td>
