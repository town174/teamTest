...
private void Data_Copy()
 {
    ...
    conn.Open();
    OleDbCommand comm;
    string Fields="name,thetable,sort_id,model_id,show_type,notshow_type,zdy_sort,zdy_condition,title_num,titlepic_width,titlepic_height,show_num,starthtml,endhtml,iswrap,tourl,title_show,zdy_style,zdy_header,layout,width,height,target,show,zdy_tag_open,zdy_tag,content,xuhao";
