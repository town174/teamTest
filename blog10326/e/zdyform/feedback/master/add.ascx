...
<tr id='tr_feedback_content'><td class='tdhead' id='tr_feedback_content'>内容<span style='color:#ff0000'>*</span></td><td><textarea name='content' id='content' style='width:80%;height:150px'   ><%if(post=="add"){Response.Write("");}else{Response.Write(r("content"));}%></textarea><span id="content_tip"></span></td></tr>
