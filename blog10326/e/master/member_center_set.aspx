...
<td valign=top align="left">
    ...
    <table border=0 cellpadding=5 cellspacing=0 width=100% align=center style="display:none" id="tb_<%#DataBinder.Eval(Container.DataItem,"id")%>">
      <tr>
       ...
       <td rowspan=10 valign=top>
         <select name="can_sortids" size="15" multiple>
    ...
    <tr>
       <td height=25px>上传权限</td>
       <td colspan=2>
        <input type="checkbox" name="up_editor_image" value="1">编辑器图片&nbsp;<input type="checkbox" name="up_editor_attachment" id="upload_editor_attachment" value="1" >编辑器附件&nbsp;
...
置顶费用：<input type="textbox"  name="settop_needpoint" size="5" Maxlength="10" onkeyup="if(isNaN(value))execCommand('undo')" value=0>积分/天
    ...
    <tr style="display:none">
       ...
       <td><input type="checkbox"  name="comments_check" value="1">允许审核 <input type="checkbox"  name="comments_delete" value="1">允许删除 <input type="checkbox" name="comments_reply" value="1">允许回复</td>
    </tr>

    <tr style="display:none">
       <td height=20px>其他功能</td>
       <td><input type="checkbox"  name="set_sign" value="1">允许设置签收 <input type="checkbox"  name="set_related" value="1">允许设置相关信息 <input type="checkbox" name="set_permission" value="1">允许设置访问权限</td>
    </tr>
  </table>
