...
<tr>
  <td>信息保存目录</td><td><asp:TextBox id="Add_Static_Dir" maxlength=50 size=30 runat="server" Text="{table}/{yyyy}{mm}{dd}" title="只有站点开启静态时此功能才有效" onblur="if(this.value==''){this.value='{table}/{yyyy}{mm}{dd}'}"/> 静态文件的目录格式，留空则默认：{table}/{yyyy}{mm}{dd}，分别表示：表/年月日</td>
</tr>
