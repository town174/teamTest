			  ...
			  <div class=nph_photo id=modePhoto342>
				  ...
				  <div class=nph_cnt>
					  <div class=nph_photo_ctrl>
						  <UL>
						  	<li><SPAN class="nph_set_cur hidden" id=photoType342>（<SPAN class=nph_c_lh id=photoIndex342></SPAN>/<%=Request.QueryString["num"]%>）</SPAN><SPAN class=nph_set_size id=streamType342>（共<SPAN class=nph_c_lh><%=Request.QueryString["num"]%></SPAN>张）</SPAN></li>
