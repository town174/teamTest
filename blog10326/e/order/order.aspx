...
<input type="button" value=" 关闭窗口/Close " class="o_bt" onclick="wclose()">
<%if(RecordCounts>0){%>
<input type="button" value=" 更新数量/Update Number " class="o_bt" onclick="edit_order()">&nbsp;
<input type="button" value=" 下一步/Next " class="o_bt" onclick="location.href='order1.aspx?s=<%=SiteId%>&table=<%=Table%>'">
<%}%>
</div>
</div>
