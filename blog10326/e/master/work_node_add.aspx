...
<table border=0 cellpadding=2 cellspacing=2 width=98% align=center>
  ...
  <td><input name="work_username" id="work_username" type="text" maxlength="50" size="20"  value="<%=Work_User%>">[<a href="#" onclick="open_departmentuser('text','work_username','','选择工作流用户')">选择用户</a>]
...
<%=Back_Options%>
<option value="0" <%=Rework_Node=="0"?"selected":""%>>退回作者</option>
</select>
</td>
  </tr>
...
<option value="next">转到下一步骤</option></select> 注：没有下一步则通过审核
  ...
  <tr>
  <td height=25 width=100px>允许删除信息</td>
  <td><input type="checkbox" name="can_delete" id="can_delete" value="1">允许</td>
  </tr>
