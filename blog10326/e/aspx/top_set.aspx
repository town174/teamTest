   ...
   if(ActPoint>0 && ActPoint>KyPoint)
   ...
   else
    {
      ...
      if(ActPoint>0)
      {
        ...
        dr.Close();
        sql="insert into pa_fnc_list(site_id,thetype,username,act,amount,detail,beizhu) values("+SiteId+",2,'"+UserName+"','k',"+ActPoint+",'信息置顶"+Request.Form["days"]+"天','标题："+Sql_Format(InfoTitle)+"')";
        comm=new OleDbCommand(sql,conn);
        comm.ExecuteNonQuery();
      }
   }
