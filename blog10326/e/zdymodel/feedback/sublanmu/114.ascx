...
<%if(IsSearch==0){conn.Open();%><div class="guestbook">
...
%>
    <li class="feedbacklist_item_jiange"></li>
    <li style="float:left;height:25px;background:url(/e/images/public/face2.gif) no-repeat 0 0;padding:0 0 0 25px;color:#ff0000">回复</li>
    <li style="float:right;height:25px;"><%=dr1["thedate"].ToString()%></li>
    <li class="feedbacklist_item_jiange"></li>
