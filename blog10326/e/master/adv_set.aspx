...
<tr id="tr_item" name="tr_item">
  ...
  <td height=25px  align="left" ><asp:TextBox id="Adv_content" TextMode="multiline" columns="75" rows="15" runat="server" /></td>
</tr>
...
<tr id="tr_item" name="tr_item">
 <td height=25px  align="left" width="100px">左侧内容<br>(ID:adv_<%=Request.QueryString["id"]%>_left)<br><a href="javascript:Open_Editor('pa_adv','left_content','<%=FieldId%>','Left_content','广告内容编辑')"><img src=images/edit.gif width=20 height=20 align=absmiddle vspace=5 hspace=5 border=0 alt="可视化编辑"></a></td>
  <td height=25px  align="left" ><asp:TextBox id="Left_content" TextMode="multiline" columns="75" rows="6" runat="server" /></td>
</tr>
...
<tr id="tr_item" name="tr_item">
  ...
  <td height=25px  align="left"><asp:TextBox id="Right_content" TextMode="multiline" columns="75" rows="6" runat="server" /></td>
</tr>
