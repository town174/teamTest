...
<tr>
 ...
 <td><input type="text" size="25" maxlength="16" name="username" id="username" class="tb"/> 由汉字、字母、数字、下划线组成(4-16位)</td>
</tr>
<%}%>
<tr>
 <td align=right>新密码<span style="color:#ff0000">*</span></td>
 <td><input type="password" size="25" maxlength="16" name="password" id="password" class="tb"/> <%=Act=="add"?"用户登录密码":"不修改密码请留空 "%></td>
</tr>
<tr>
