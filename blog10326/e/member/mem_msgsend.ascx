    ...
    <td valign=top>
     <table cellpadding="5px" cellspacing=0 border=0 align=left width=100% style="table-layout:fixed">
       ...
       <tr id="tr_title">
        ...
        <td align=left><input type="text"  id="fb_title"  name="fb_title"  maxlength="100" style="width:300px" class="tb"  value="<%=The_Title%>"></td>
       </tr>
       <tr id="tr_content">
        <td align=right>内容：</td>
        <td align=left><textarea name="Content" id="Content"><%=The_Content%></textarea>
