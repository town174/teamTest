...
<tr style="display:<%=IsZt=="1"?"":"none"%>">
  <td>专题名称</td>
  <td><asp:textBox TextMode="singleLine" id="tb_name" runat="server" maxlength="50" style="width:300px" /> 
...
<tr style="display:<%=LanmuType=="home"?"none":""%>">
    <td>当前位置样式</td>
    <td><input type="radio" name="location_style" value="0" checked>显示栏目名称（如：首页 &gt; 栏目名 &gt; 子栏目名称）
    <input type="radio"  name="location_style" value="1" <%=Location_Style=="1"?"checked":""%>>不显示栏目名称（如：首页 &gt; 子栏目名称）
  </td>
 </tr>
...
<tr>
  ...
  <td><asp:TextBox  id="Dropmenuzdy"  TextMode="MultiLine"  runat="server" style="width:600px;height:100px"/>
  </td>
 </tr>
<tr>
